...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos de la veterinario &raquo; Perfil</h2>
			<hr />
			...
			$sql = mysqli_query($con, "SELECT * FROM veterinario WHERE id_veterinarios='$nik'");
			...
			if(isset($_GET['aksi']) == 'delete'){
				$delete = mysqli_query($con, "DELETE FROM veterinario WHERE id_veterinarios='$nik'");
				if($delete){
			...
			<table class="table table-striped table-condensed">
				<tr>
					...
					<td><?php echo $row['id_veterinarios']; ?></td>
				</tr>
				<tr>
