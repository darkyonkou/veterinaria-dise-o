	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM clientes WHERE id_clientes='$id_clientes'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO clientes(id_clientes, identificacion, nombres, apellidos, direccion, telefono, Genero)
															VALUES('$id_clientes','$identificacion','$nombres','$apellidos','$direccion', '$telefono', '$Genero' )") or die(mysqli_error());
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="id_clientes" class="form-control" placeholder="Código" required>
					</div>
				</div>
				<div class="form-group">
