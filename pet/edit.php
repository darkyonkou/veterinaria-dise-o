...
<body>
	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				$id_clientes		     = mysqli_real_escape_string($con,(strip_tags($_POST["id_clientes"],ENT_QUOTES)));//Escanpando caracteres 
				...
				$update = mysqli_query($con, "UPDATE clientes SET identificacion='$identificacion', nombres='$nombres', apellidos='$apellidos', direccion='$direccion', telefono='$telefono', Genero='$Genero' WHERE id_clientes='$nik'") or die(mysqli_error());
				if($update){
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="id_clientes" value="<?php echo $row ['id_clientes']; ?>" class="form-control" placeholder="NIK" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Identificacion</label>
					<div class="col-sm-4">
						<input type="text" name="identificacion" value="<?php echo $row ['identificacion']; ?>" class="form-control" placeholder="identificacion" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="Genero" class="form-control">
                            ...
                            <option value="1" <?php if ($row ['Genero']==1){echo "selected";} ?>>Masculino</option>
							<option value="2" <?php if ($row ['Genero']==2){echo "selected";} ?>>Femenino</option>
							<option value="3" <?php if ($row ['Genero']==3){echo "selected";} ?>>Other</option>
						</select> 
					</div>
